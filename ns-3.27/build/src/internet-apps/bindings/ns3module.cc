...
_wrap_PyNs3DhcpHeader_SetChaddr(PyNs3DhcpHeader *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(addr, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Inet6SocketAddress, InetSocketAddress, Ipv4Address, Ipv6Address, Mac48Address, Mac64Address), not %s", Py_TYPE(addr)->tp_name);
        return NULL;
    }
...
_wrap_PyNs3DhcpServer_AddStaticDhcpEntry(PyNs3DhcpServer *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(chaddr, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Inet6SocketAddress, InetSocketAddress, Ipv4Address, Ipv6Address, Mac48Address, Mac64Address), not %s", Py_TYPE(chaddr)->tp_name);
        return NULL;
    }
